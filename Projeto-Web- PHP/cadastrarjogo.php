...
<html lang="pt-br">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
	...
	<h1>Cadastrar Jogo</h1>
		...
		<form method="POST" action="processacadjogo.php">
			<label>Nome: </label></br>
			<input type="text" name="nome" placeholder="XXXX-XXXX" disabled><br><br>

			<label>Campeonato: </label></br>
			<input type="text" name="campeonato" placeholder="Digite o campeonato"><br><br>
			...
			<label>Local do jogo: </label></br>
			<input type="text" name="localjogo" placeholder="Digite o local do jogo"><br><br>

			<label>Data do Jogo: </label></br>
			<input type="date" name="datajogo" placeholder="Digite a data do  jogo"><br><br>

			<label>Horário: </label></br>
			<input type="int" name="horario" placeholder="Digite o horário do jogo"><br><br>
