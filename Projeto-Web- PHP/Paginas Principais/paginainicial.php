...
<img src="img/002.jpg" width="30" height="30" class="d-inline-block left-top">
  <h5 class="my-1 mr-md-auto "><a href="paginainicial.php" role="submit" >QUICK APOSTAS</h5>
  <a class="btn btn-outline-primary" href="paginalogin.php">Login</a>
  <a class="btn btn-outline-primary" href="paginacadastrar.php">Registrar</a>
</div>


<ul class="list-group list-group-horizontal">
  <li class="list-group-item"><a href="detalhejogo.php" class="list-group-item list-group-item-action" ><p class="text-danger" p align="Center">AO VIVO </p><strong>FLAMENGO<!---->  0  VASCO<!-- --> 0</strong></br>SÉRIA A </a></li>
  <li class="list-group-item"><a href="detalhejogo1.php" class="list-group-item list-group-item-action" ><p class="text-success" p align="Center">ENCERRADO </p><strong>FLUMINENSE<!-- -->  0  BOTAFOGO<!-- --> 0</strong><br>SÉRIA A</a></li>
  <li class="list-group-item"><a href="detalhejogo2.php" class="list-group-item list-group-item-action" ><p class="text-danger" p align="Center">AO VIVO </p><strong>AVAI<!---->  0  FORTALEZA<!-- --> 0</strong><br>SÉRIA A </a></li>
  <li class="list-group-item"><a href="detalhejogo3.php" class="list-group-item list-group-item-action" ><p class="text-success" p align="Center">ENCERRADO </p><strong>GREMIO<!-- -->  0  CORINTHIAS<!-- --> 0</strong><br>SÉRIA A</a></li>
